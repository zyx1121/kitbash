...
- A skill carries pinned digests and measured numbers, and both age. Whether an evaluation kit replays each recipe on a schedule and flags the ones that no longer hold, or a recipe states the version it was verified on and nothing more, is open until the first recipe goes stale.
