...
When M13 begins, the "more than one machine" line of 5.2 and the "any runner other than rootless podman" line stop being true and are removed from 5.2 in that pull request rather than in this one.
