...
//
// This is the v0.5.0 era: signals carry a producer but no caller and no
// internal, processes carry a container and a digest but no fan out secret and
// no permits, and approvals exist in all three states.
package main
