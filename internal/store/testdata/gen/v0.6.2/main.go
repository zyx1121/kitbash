...
//
// This is the v0.6.2 era: signals carry producer and caller but no internal,
// processes carry a container, a digest and a fan out secret but no permits,
...
func run(path string) error {
	...
	if err := s.RegisterProcess(ctx, store.Process{
		...
		FanoutSecret:  "fixture-fanout-secret-alpha",
