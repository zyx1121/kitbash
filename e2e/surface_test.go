...
func TestSurface(t *testing.T) {
	...
	steps := []struct {
		...
		{"proc_logs reads either unit and pkg_inspect lists both", readEitherUnit},
		{"tel_query by unit answers the probe of the face", theProbeCarriesTheUnit},
		{"stopping the cache makes proc_list name the unit that is down", theCacheUnitGoesDown},
